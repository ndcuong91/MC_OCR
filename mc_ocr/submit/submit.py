...
def compare_result(first_res_dir, second_res_dir):
    ...
    list_files = get_list_file_in_folder(first_res_dir, ext=['txt'])
    for idx, file in enumerate(list_files):
        print(idx, file)
...
if __name__ == '__main__':
    ...
    first_res_dir = '/data20.04/data/MC_OCR/test_output/key_info_extraction/mc_ocr_train_filtered/txt'
    second_res_dir = '/data20.04/data/MC_OCR/output_results/key_info_extraction/mc_ocr_train_combine_lines_filtered/txt'
